      ...
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-border">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium">AI Audit</span>
            {report && (
...
function VideoAuditNodeComponent({ id, data, selected }: NodeProps) {
  ...
  return (
    <div className="relative max-w-[240px]">
        ...
        <div className="flex flex-col gap-2 p-3 h-full" style={{ minHeight: 160 }}>
          ...
          {status !== "running" && status !== "failed" && scenes.length === 0 && !report && (
            ...
            >
              ...
              <span className="text-[10px]">Connect a video to audit</span>
            </div>
          )}
      ...
      <HandleWithPopover nodeId={id} nodeType="video-audit" handleId="json"     type="source" position={Position.Right} label="Scenes JSON" color={DATA_HANDLE_COLORS.json} icon={<Braces />} side="right" top="24px" />

...
- The frame is exported as PNG (lossless), not JPEG — safe to route into upscale, edit-image, or as the anchor frame for video continuation (extends) without adding compression artifacts to the chain.

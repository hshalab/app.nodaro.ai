...
| Resolution | Select | 720p | Output resolution: 480p/720p (most KIE providers); OmniHuman 1.5 is 720p/1080p (default 1080p); only the full `seedance-2` adds **1080p / 4K** (`seedance-2-fast`, `seedance-2-mini` and `seedance-2-5` are 480p/720p only) |

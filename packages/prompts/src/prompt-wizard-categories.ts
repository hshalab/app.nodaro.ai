...
export const PROVIDER_CAPABILITIES: Record<string, Record<string, string>> = {
  ...
  "text-to-video": {
    ...
    "minimax-h3": "MiniMax Hailuo 3 — premium multimodal refs (9 images / 3 videos / 3 audio), always-on audio, fixed 2K, 4-15s per-second pricing",
  ...
  "image-to-video": {
    ...
    "minimax-h3": "MiniMax Hailuo 3 — first/last frame + multimodal refs, always-on audio, fixed 2K, 4-15s",
